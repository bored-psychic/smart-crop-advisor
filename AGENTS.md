...
static web UI (`web/`). ML via Scikit-learn, Prophet, optionally TensorFlow.
Bioacoustic analysis via Anthropic API.
...
- **`web/` is the only frontend.** No npm, no build steps — vanilla HTML/JS served statically.
