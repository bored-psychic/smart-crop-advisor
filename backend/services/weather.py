...
class WeatherService:
    ...
    @staticmethod
    async def fetch_field_watch(city: str):
        from services.field_watch import fetch_field_watch
        return await asyncio.get_event_loop().run_in_executor(None, fetch_field_watch, city)
